...
define(["exports", "scenegraph", "animation"], //
	function(exports, scenegraph, animation) {
		...
		function init() {
			...
			var sonne = scenegraph.createNodeWithModel("Sun", "sphere", {recursionDepth: 4, color:5}, null, true);
			sonne.translate([0, 0, 0])
			animation.assign(sonne, "rotate", {rotationSpeed: [0, 0.001, 0]});

			var erde = scenegraph.createNodeWithModel("Earth", "sphere", {recursionDepth: 4, scale: 100, color:1}, sonne, false);
			erde.translate([600, 0, 0]);
			animation.assign(erde, "rotate", {rotationSpeed: [0, 0.03, 0]});

			var mond = scenegraph.createNodeWithModel("Moon", "sphere", {recursionDepth: 4, scale: 25, color:2}, erde, false);
			mond.translate([250, 0, 0]);
			animation.assign(mond, "move", {rotationSpeed: [0, 0.01, 0]})

			var mars = scenegraph.createNodeWithModel("Mars", "sphere", {recursionDepth: 4, scale: 75, color:0}, sonne, false);
			mars.translate([-1000, 0, 0]);
			animation.assign(mars, "rotate", {rotationSpeed: [0, 0.05, 0]});
